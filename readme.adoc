...
The Svhad extension adds support and CSR control for hardware updating of PTE A/D bits.
...
```
  git clone --recurse-submodule https://github.com/riscv/riscv-svhad.git
  cd ./riscv-svhad.git
