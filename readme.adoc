...
The Ssvhadu extension adds support and CSR control for hardware updating of PTE A/D bits for single-stage address translation. The Shvhadu extension adds support and CSR controls for hardware updating of PTE A/D bits for two-stage (G-stage and VS-stage) address translation.
