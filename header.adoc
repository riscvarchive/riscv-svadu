[[header]]
:description: RISC-V Hardware Updating of PTE A/D Bits (Ssvhadu and Shvhadu)
:company: RISC-V.org
:revdate: 1/2022
:revnumber: 1.0
...
= RISC-V Hardware Updating of PTE A/D Bits (Ssvhadu and Shvhadu)
ved Shanbhogue
...
Aaron Durbin, Earl Killian, Greg Favor, Krste Asanović, Ved Shanbhogue

[preface]
include::ssvhadu.adoc[]
